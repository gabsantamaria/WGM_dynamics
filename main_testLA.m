...
%loss_coup = 9; 			%[DEPRECATED] %loss of coupler waveguides (dB/m)
loss_coup_L3 = 9; 			%loss of coupler waveguide section L3  (dB/m)
loss_coup_L4 = 9; 			%loss of coupler waveguide section L4  (dB/m)
loss_int_La  = 9; 			%loss of interferometer waveguide section La  (dB/m)
loss_int_Lb  = 9; 			%loss of interferometer waveguide section Lb  (dB/m)
...
la = lb + 0.25*c/((FSR)*neff_res);	%Length of "a" arm of the M-Z interferometer
